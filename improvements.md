...
✅ Also cleaned (this PR): SGR wrap-helpers in sugar-table (StyledCell/Column/Table), sugar-stickers (Table/FlexBox), sugar-calendar (DatePicker), candy-lister (Model) routed through Ansi::CSI/Ansi::reset().
