...
2. **Claude Code's per-project memory store** (`~/.claude/projects/<slug>/memory/`), which held 44
...
### `CONTEXT.md`
The 44 memory entries, bodies verbatim, grouped by kind with an index. Read the header before the
