...
|------|------|--------|--------|-----------|------------|-------|-------------|
| META:NEXT_START_SHA | - | - | - | 2552d2090 (Q0; one bookkeeping commit follows, touching only shared-exempt files — §2) | - | - | updated in same bookkeeping edit as every commit (§10) |
