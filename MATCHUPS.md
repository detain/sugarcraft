...
| [charmbracelet/x/xpty](https://github.com/charmbracelet/x/tree/main/xpty) | **CandyPty** | `candy-pty/` | `sugarcraft/candy-pty` | `SugarCraft\Pty` | 🟡 | PTY primitive — `Pty::open()` round-trip via FFI to libc (Linux + macOS); spawn/resize/non-blocking I/O land in PR2-PR5 |
